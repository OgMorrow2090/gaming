---
name: start
description: Bootstrap a gaming session — Bazzite/Sunshine/Moonlight configs for shaun-bazzite (repo formerly named guildwars2)
disable-model-invocation: true
---

Start a session for the **gaming** project (repo renamed from `guildwars2` 2026-06).

## Project quick context

- Gaming PC configs — Bazzite OS, Sunshine streaming server, Moonlight client setup, Steam Deck controller scripts, GW2 dashboards.
...
1. Run the central checklist `session-start-checklist.md` from the dev-toolkit repo — wednesday `/srv/docker-data/repos/dev-toolkit/session-start-checklist.md`, Mac `~/Developer/GitHub/itinyk/dev-toolkit/session-start-checklist.md` (it self-detects the rest).
