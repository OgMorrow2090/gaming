...
constexpr const char* ACCEPT = "ACCEPT";                    // displayed as "Accept 1" in capture UI
constexpr const char* GENERAL_ACCEPT = "GENERAL_ACCEPT";    // displayed as "Accept 3" in capture UI
...
constexpr const char* ACCEPT_15 = "ACCEPT_15";  // displayed as "Accept 15 (Yes)" — fires LAST in combo
...
void SimulateCopyItemName();    // Hover item + hotkey → chat-link → GW2 API → clipboard (item name)
