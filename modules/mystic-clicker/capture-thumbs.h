...
// is captured, also grab a 768x320 region of the back buffer around it and
...
//
// Wide-rectangle aspect (2.4:1) matches the GW2 UI elements being captured —
// dialog buttons with adjacent label text, often with neighbouring buttons
// laid out horizontally — so the context that identifies a slot lands inside
// the grab.
...
constexpr int WIDTH  = 768;  // captured + stored at this size — wide rectangle
constexpr int HEIGHT = 320;  // matches GW2 dialog button layouts (2.4:1)
