...
static CaptureTarget s_Targets[] = {
    ...
    {"General Accept 1",  "Generic Accept dialog (combo step 1)", &g_GeneralAcceptX, &g_GeneralAcceptY},
    {"General Accept 2",  "Generic Accept dialog (combo step 2)", &g_GeneralAccept2X, &g_GeneralAccept2Y},
    {"General Accept 3",  "Generic Accept dialog (combo step 3)", &g_GeneralAccept3X, &g_GeneralAccept3Y},
    {"General Accept 4",  "Generic Accept dialog (combo step 4)", &g_GeneralAccept4X, &g_GeneralAccept4Y},
