...
CUSTOM_DTDS = [
    (1280, 800,  90,  100, 160),  # Steam Deck OLED native
    (2560, 1440, 60,  600, 340),  # 1440p 60Hz
    (1920, 1080, 144, 600, 340),  # 1080p 144Hz
    (2560, 1440, 120, 600, 340),  # 1440p 120Hz alt
]
# ─────────────────────────────────────────────────────────────────────────────
...
def build_cta_extension():
    ...
    data.extend([0x66, 0x03, 0x0C, 0x00, 0x10, 0x00, 0xFA])  # max TMDS 1250MHz (HDMI 2.1)

    # HDMI Forum VSDB — declares HDMI 2.1 / SCDC
    data.extend([0x67, 0xD8, 0x5D, 0xC4, 0x01, 0xFF, 0x80, 0x00])
