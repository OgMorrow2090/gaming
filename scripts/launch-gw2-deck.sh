#!/bin/bash
# launch-gw2-deck: non-Steam GW2 Steam Deck profile (compatdata appid 3111887265)
...
LOG="/var/home/Og/.local/state/launch-gw2-deck.log"
mkdir -p "$(dirname "$LOG")"
exec > >(tee -a "$LOG") 2>&1
echo "=== $(date -Iseconds) === GW2 Deck launch starting"

PROTON="$HOME/.steam/steam/steamapps/common/Proton 11.0/proton"
APPID="3111887265"
GAME_DIR="$HOME/Games/gw2-deck"
...
echo "=== $(date -Iseconds) === GW2 Deck exited"
